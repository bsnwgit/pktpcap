...
type TabId = 'general' | 'security' | 'data' | 'notifications' | 'apikeys' | 'captures' | 'ingest'
            ...
            {securityTab === 'ai' && (
              <Section title="AI Assistant" onSave={aiAssistantSave.save} saving={aiAssistantSave.saving} saved={aiAssistantSave.saved} error={aiAssistantSave.error}
                help={{
                  ...
                  content: <p>pktPCAP supports either <span className="text-gray-300 font-medium">Anthropic</span> or <span className="text-gray-300 font-medium">OpenAI</span> as the AI provider — pick one below. The in-app chat panel sends your question plus the current view's capture context to whichever provider is selected.</p>,
                }}
              >
                ...
                {str('provider', 'anthropic') === 'anthropic' ? (
                  <>
                    <Field label="Anthropic API key" hint="Get a key at console.anthropic.com">
                  ...
                  <>
                    <Field label="OpenAI API key" hint="Get a key at platform.openai.com">
