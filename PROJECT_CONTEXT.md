...
**Current status (as of 2026-07-01):** App is DEPLOYED and running at https://localhost:8765 (SSL enabled). Git repos are live on GitHub (`bsnwgit/pktpcap`) and GitLab (`robert.barnett/pktanalyzer`). Active branch: `feature/ssl-cert-settings`.
...
**Script:** `C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\Packet Analyzer\backup.py`
**Backup location:** `C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\pktpcap_backups\` (backup_1 = most recent, backup_2 = previous)

Run via Desktop Commander:
```
C:\Users\robert.barnett\AppData\Local\Programs\Python\Python313\python.exe "C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\Packet Analyzer\backup.py"
```
