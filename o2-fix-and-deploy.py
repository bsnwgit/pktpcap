...
LOCAL_BASE     = r"C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\Packet Analyzer\service"
REMOTE_BASE    = "/mnt/software/pktpcap"

UPLOAD_FILES = [
    (LOCAL_BASE + r"\server.py",                    REMOTE_BASE + "/server.py"),
    (LOCAL_BASE + r"\db.py",                        REMOTE_BASE + "/db.py"),
    (LOCAL_BASE + r"\logging_handler.py",           REMOTE_BASE + "/logging_handler.py"),
    (LOCAL_BASE + r"\templates\settings.html",      REMOTE_BASE + "/templates/settings.html"),
    (LOCAL_BASE + r"\static\index.html",            REMOTE_BASE + "/static/index.html"),
    (LOCAL_BASE + r"\static\nav.js",                REMOTE_BASE + "/static/nav.js"),
    (LOCAL_BASE + r"\static\logo.png",              REMOTE_BASE + "/static/logo.png"),
]
...
for local, remote in UPLOAD_FILES:
    ...
    safe_print("Uploaded: " + remote.replace(REMOTE_BASE + "/", ""))
sftp.close()
