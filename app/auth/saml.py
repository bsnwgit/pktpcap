"""
SAML 2.0 SP helpers for pktPCAP.
Identical to the pktSNMP/pktFlow/pktWiFi implementation — only the default base_url differs.
"""
...
async def load_saml_settings(db) -> Optional[dict]:
    ...
    base_url     = _decode(kv, "base_url", "http://localhost:8765").rstrip("/")
